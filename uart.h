...
#define UART_TRANSMIT_SIZE 20

#define UART_END_OF_RECEPTION '#'

extern xdata unsigned char _uart_receiveData[UART_RECEIVE_SIZE];
extern unsigned char _uart_receiveSize;
extern bit _uart_receiveFlag;

extern unsigned char _uart_transmitData[UART_TRANSMIT_SIZE];
extern unsigned char _uart_transmitSize;
